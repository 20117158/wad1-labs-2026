...
createView(request, response) {
    ...
    let largestPlaylist = playlists.reduce((largest, playlist) => playlist.songs.length > largest.songs.length ? playlist : largest);
    ...
    const statistics = {
        ...
        displayLargest: largestPlaylist.title,
        displayLargestSize: largestPlaylist.songs.length,
    };
